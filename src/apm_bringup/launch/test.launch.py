...
def func_demo(context: LaunchContext, arg1: LaunchConfiguration):
    ...
    run_script = ExecuteProcess(cmd=[["/home/user/apm_ws/src/apm_bringup/scripts/hello.zsh ", data]], shell=True)
    return [run_script]
...
def generate_launch_description():
    ...
    arg1_arg = DeclareLaunchArgument("arg1", default_value="hello_world", description="arg1")
