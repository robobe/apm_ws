...
#     def __init__(
#         self, id_to_find, marker_size, camera_matrix, camera_distortion, camera_size=[640, 480], show_video=False
#     ):
...
#         id_to_find=3, marker_size=10, show_video=False,
